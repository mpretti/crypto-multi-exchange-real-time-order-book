...
export const exchangeSelectorDiv = document.getElementById('exchange-selector') as HTMLDivElement;
...
// Text Summarizer DOM Elements
export const textSummarizerSectionEl = document.getElementById('text-summarizer-section') as HTMLElement;
export const textToSummarizeEl = document.getElementById('text-to-summarize') as HTMLTextAreaElement;
export const summarizeBtn = document.getElementById('summarize-btn') as HTMLButtonElement;
export const summaryOutputEl = document.getElementById('summary-output') as HTMLDivElement;